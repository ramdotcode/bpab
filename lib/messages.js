...
export function msgFotoMeteran(t, template) {
  return (template || TEMPLATE_FOTO_METERAN)
    ...
    .replace(/\{periode\}/gi, t.periodeLabel || 'Bulan_Ini')
    .trim();
}
...
export const MODES = {
  'foto-meteran': {
    ...
    desc: 'Pelanggan yang belum input meteran pada periode terpilih.',
    // Punya pemilih periode: bisa menarik target bulan lalu, bukan hanya bulan berjalan.
    periodik: true,
  },
  'tagihan-detail': {
